...
$adres_odbiorcy = 'szkolenia@sew-eurodrive.pl'; 	//tu wpisz adres e-mail na który mają przychodzić wiadomości
...
$komunikat['blad'] = 'Wiadomość <b><font style="color:#f00">NIE</font></b> została wysłana. Popraw poniższe błędy.'; 	//Wiadomość przy błędzie w sprawdzaniu danych, błędy zostaną wymienione poniżej
$komunikat['nick'] = 'Imię i Nazwisko musi mieć min. 2 znaki.'; 	//Wpisz właściwą ilość znaków jeśli pole wymagane
